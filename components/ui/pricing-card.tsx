	...
	return (
		<div
			className={cn(
				...
				'border border-border-custom/80',
				className,
			)}
			{...props}
		/>
...
function Header({
	...
	return (
		<div
			className={cn(
				'bg-pricing-header relative mb-4 rounded-xl border border-border-custom p-4 z-10',
				className,
			)}
			{...props}
		>
...
function Description({ className, ...props }: React.ComponentProps<'p'>) {
	return (
		<p className={cn('text-text-muted text-xs', className)} {...props} />
	);
}
...
function PlanName({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div
			className={cn(
				"text-text-muted flex items-center gap-2 text-sm font-medium [&_svg:not([class*='size-'])]:size-4",
				className,
			)}
			{...props}
		/>
...
// Ensure the Price container allows line-through side-by-side or stack
function Price({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		<div className={cn('mb-3 flex items-end gap-1 flex-wrap', className)} {...props} />
	);
}
...
function Period({ className, ...props }: React.ComponentProps<'span'>) {
	return (
		<span
			className={cn('text-text-muted pb-1 text-sm', className)}
			{...props}
		/>
	);
}
...
function OriginalPrice({ className, ...props }: React.ComponentProps<'span'>) {
	return (
		<span
			className={cn(
				'text-text-muted mr-1 ml-auto text-lg line-through',
				className,
			)}
			{...props}
		/>
...
// Add a helper for showing coupon discount label
export function DiscountLabel({ className, ...props }: React.ComponentProps<'span'>) {
	return (
		<span
			className={cn(
				'text-emerald-500 font-semibold text-xs ml-auto',
				className,
			)}
			{...props}
		/>
...
function ListItem({ className, ...props }: React.ComponentProps<'li'>) {
	return (
		<li
			className={cn(
				'text-text-muted flex items-start gap-3 text-sm',
				className,
			)}
			{...props}
		/>
